...
<div class="wrapper">
    <x-sidebar>
        <div>
            ...
            <ul class="menu">
                <li><a href="/teacher/dashboard" class="{{ request()->is('teacher/dashboard') ? 'active' : '' }}"><i class="fa-regular fa-calendar"></i> My Schedule</a></li>
                <li><a href="/teacher/classes" class="{{ request()->is('teacher/classes*') ? 'active' : '' }}"><i class="fa-solid fa-users"></i> My Classes</a></li>
